...
const QuestionContextProvider = props => {
  const questions = [
    {
      id: 1,
      content: "There are many variations of passages of Lorem Ipsum available, words which don't look even slightly believable.",
  ...
  return (
    <QuestionContext.Provider value={{ questions, selectedQuestion, nextQuestion, prevQuestion }}>
      {props.children}
